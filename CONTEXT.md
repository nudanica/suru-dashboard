# 📋 SURU Dashboard — Project Context (อัปเดตจากเว็บ live จริง 14 มิ.ย. 2026)
...
### 🚀 วิธี deploy ของ user (ทำแบบนี้เท่านั้น)
**GitHub repo → ลบ index.html เดิม → อัปโหลดไฟล์ใหม่ทับ → Commit**
- หลัง deploy refresh ล้าง cache (Mac: Cmd+Shift+R) ก่อนตรวจ
- **ปัญหาเจอบ่อย:** user ยัง deploy ไฟล์ล่าสุดไม่ทัน → เห็นของเก่า → คิดว่าแก้ไม่สำเร็จ → **เช็คเสมอว่า deploy หรือยังก่อนสรุป**
...
### Dashboard Data Sheets (แท็บ): ยอดขาย_รายวัน · ยอดขาย_สรุปเดือน · รายจ่าย · ค่าแอด · สต๊อก · ภาษี_รายเดือน · รายจ่ายประจำ · (น่าจะมีแท็บผันแปร ค่าส่ง/Line เพิ่ม — ควรเช็คชื่อจริงตอนแก้)
